...
import com.example.rental.services.Impl.AppUserDetailsService;
                ...
                .authorizeHttpRequests(
                        authorizeHttpRequests ->
                                authorizeHttpRequests.
                                        ...
                                        requestMatchers("/client/profile").hasAnyRole(UserRoles.CLIENT.name(), UserRoles.ADMIN.name()).
                                        requestMatchers("/review/**").hasAnyRole(UserRoles.CLIENT.name()).
                                        requestMatchers("/agent/**").hasAnyRole(UserRoles.AGENT.name()).
